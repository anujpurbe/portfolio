...
import { SCROLL_TARGETS } from "./config";
...
// Canonical portfolio view for the assistant — assembled ONLY from the real
// src/data/* files. Never store portfolio facts inline here; if a fact is not
// in a data file, add it there and let it flow through.
export const portfolio = {
  ...
  skillsCurrent: currentStack,
  skillsExploring: aspiringStack,
  projects: projects,
  certifications: certifications,
  achievements: achievements,
  stats: stats,
  scrollTargets: SCROLL_TARGETS,
} as const;
...
// Facts-only prompt context for the AI model. Same content as the legacy
// knowledge builder; now derived from the same canonical object above.
